...
Access is strictly read-only: no log config editing, truncation, deletion, rotation, export,
or remote grep. Default read size is the last 200 lines (100 / 200 / 500 / 1000 selectable).
